...
const cancelEmail = (reserva)  => {

    const {status, fecha, hora, Doctor, Paciente, Specialty} = reserva;
                            ...
                            <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        background-color: #ff0000; border-radius: 10px;text-align: center;padding: 5px; ">
                                            <span style="color: #fff;">Aviso de cancelación de reserva médica</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        text-align: center;padding: 5px; ">
                                            <p style="color:gray;">Estimado paciente, se le a cancelado una hora médica con la siguiente información:</p>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        border: 2px solid #ff0000; border-radius: 10px;padding: 5px; ">
                                            ...
                                            <span style="color: gray; text-align: right; font-size: 20px; margin-left: 20px;">${Specialty.name}</span>
                                        </td>
                                    ...
                                    <tr><td><br></td></tr>
                                    <tr>
                                        <td style="color: #153643; font-family: Times, serif,Arial, sans-serif; font-size: 20px;
                                        background-color: #ff0000; border-radius: 10px; text-align: center;padding: 5px; ">
                                            <p style="color:#fff;">Si necesita mas información de la cancelación comuniquese con nuestro Call Center</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
